...
export default function UpdateBanner({ onGo }) {
  ...
  return (
    <div className="tw:!mb-4 tw:!flex tw:!items-center tw:!gap-3 tw:!rounded-xl tw:!border tw:!border-emerald-200 tw:!bg-gradient-to-r tw:!from-emerald-50 tw:!to-teal-50 tw:!px-4 tw:!py-3 tw:!shadow-sm">
      <span className="tw:!text-xl" aria-hidden="true">🎓</span>
      <div className="tw:!min-w-0 tw:!flex-1">
        <div className="tw:!text-[11px] tw:!font-extrabold tw:!tracking-wide tw:!text-emerald-700">UPDATE · 2027학년도 모집요강 반영</div>
      ...
      <button
        type="button"
        className="tw:!shrink-0 tw:!rounded-lg tw:!bg-emerald-600 tw:!px-3.5 tw:!py-2 tw:!text-sm tw:!font-bold tw:!text-white tw:transition-colors tw:hover:!bg-emerald-700"
